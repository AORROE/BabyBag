...
import com.hwt.babybag.utils.DpUtils;
...
public class CircleImageVIew extends AppCompatImageView {
    ...
    public void setBorderWidth(int borderWidth) {
        this.borderWidth = DpUtils.dp2px(context, borderWidth);
    ...
    public void setInnerBorderWidth(int innerBorderWidth) {
        this.innerBorderWidth = DpUtils.dp2px(context, innerBorderWidth);
        clearInnerBorderWidth();
        invalidate();
    }
    ...
    public void setCornerRadius(int cornerRadius) {
        this.cornerRadius = DpUtils.dp2px(context, cornerRadius);
        calculateRadiiAndRectF(false);
    }

    public void setCornerTopLeftRadius(int cornerTopLeftRadius) {
        this.cornerTopLeftRadius = DpUtils.dp2px(context, cornerTopLeftRadius);
        calculateRadiiAndRectF(true);
    }

    public void setCornerTopRightRadius(int cornerTopRightRadius) {
        this.cornerTopRightRadius = DpUtils.dp2px(context, cornerTopRightRadius);
        calculateRadiiAndRectF(true);
    }

    public void setCornerBottomLeftRadius(int cornerBottomLeftRadius) {
        this.cornerBottomLeftRadius = DpUtils.dp2px(context, cornerBottomLeftRadius);
        calculateRadiiAndRectF(true);
    }

    public void setCornerBottomRightRadius(int cornerBottomRightRadius) {
        this.cornerBottomRightRadius = DpUtils.dp2px(context, cornerBottomRightRadius);
        calculateRadiiAndRectF(true);
    }
