...
public class IJklayerVideoView extends FrameLayout {
    ...
    public IJklayerVideoView(Context context) {
        super(context,null);
        init(context);
    }

    public IJklayerVideoView(Context context, AttributeSet attrs) {
        super(context, attrs,0);
        init(context);
    }

    public IJklayerVideoView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        mSurfaceView.setLayoutParams(layoutParams);
    ...
    public void load() throws IOException {
        ...
        mMediaPlayer.setDataSource(mContext, Uri.parse(videoPath),requestHeader);
